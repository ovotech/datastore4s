...
object DatastoreService {
  ...
  def put[E <: DatastoreEntity[_]](entityObject: E)(implicit keyFactorySupplier: () => com.google.cloud.datastore.KeyFactory, format: EntityFormat[E, _], datastore: Datastore): Persisted[E] = {
