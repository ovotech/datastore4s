...
object ValueFormat {
  ...
  implicit object StringValueFormat
      extends ValueFormat[String]
      with DatastoreErrors {
    override def toValue(scalaValue: String): DatastoreValue =
      StringValue(scalaValue)

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, String] =
  ...
  implicit object LongValueFormat
      extends ValueFormat[Long]
      with DatastoreErrors {
    override def toValue(scalaValue: Long): DatastoreValue =
      LongValue(scalaValue)

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Long] =
      datastoreValue match {
  ...
  implicit object IntValueFormat extends ValueFormat[Int] with DatastoreErrors {
    ...
    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Int] =
      datastoreValue match {
  ...
  implicit object DoubleValueFormat
      extends ValueFormat[Double]
      with DatastoreErrors {
    override def toValue(scalaValue: Double): DatastoreValue =
      DoubleValue(scalaValue)

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Double] =
      datastoreValue match {
  ...
  implicit object BooleanValueFormat
      extends ValueFormat[Boolean]
      with DatastoreErrors {
    override def toValue(scalaValue: Boolean): DatastoreValue =
      BooleanValue(scalaValue)

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Boolean] =
      datastoreValue match {
  ...
  implicit object BlobValueFormat
      extends ValueFormat[Blob]
      with DatastoreErrors {
    override def toValue(scalaValue: Blob): DatastoreValue =
      BlobValue(scalaValue)

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Blob] =
      datastoreValue match {
  ...
  implicit object TimestampValueFormat
      extends ValueFormat[Timestamp]
      with DatastoreErrors {
    override def toValue(scalaValue: Timestamp): DatastoreValue =
      TimestampValue(scalaValue)

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Timestamp] =
      datastoreValue match {
  ...
  implicit object LatLngValueFormat
      extends ValueFormat[LatLng]
      with DatastoreErrors {
    override def toValue(scalaValue: LatLng): DatastoreValue =
      LatLngValue(scalaValue)

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, LatLng] =
      datastoreValue match {
  ...
  object ByteArrayValueFormat extends ValueFormat[Array[Byte]] {
    ...
    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Array[Byte]] =
  ...
  object InstantEpochMillisValueFormat extends ValueFormat[Instant] {
    ...
    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, Instant] =
      LongValueFormat.fromValue(datastoreValue).map(Instant.ofEpochMilli)

  }

  object BigDecimalStringValueFormat
      extends ValueFormat[BigDecimal]
      with DatastoreErrors {
    override def toValue(scalaValue: BigDecimal): DatastoreValue =
      StringValueFormat.toValue(scalaValue.toString())

    override def fromValue(
        datastoreValue: DatastoreValue): Either[DatastoreError, BigDecimal] =
      StringValueFormat.fromValue(datastoreValue).flatMap { str =>
        Try(BigDecimal(str)) match {
          case Success(bd) => Right(bd)
          case Failure(exception) =>
            error(
              s"Could not parse BigDecimal from $str. Error: ${exception.getMessage}")
        }
      }
  }

  implicit def optionValueFormat[A](
      implicit elementFormat: ValueFormat[A]): ValueFormat[Option[A]] =
    new ValueFormat[Option[A]] {
      ...
      override def fromValue(
          datastoreValue: DatastoreValue): Either[DatastoreError, Option[A]] =
        datastoreValue match {
  ...
  implicit def listValueFormat[A](
      implicit elementFormat: ValueFormat[A]): ValueFormat[Seq[A]] =
    new ValueFormat[Seq[A]] with DatastoreErrors {
      ...
      override def fromValue(
          datastoreValue: DatastoreValue): Either[DatastoreError, Seq[A]] =
        datastoreValue match {
  ...
  def formatFromFunctions[A, B](constructor: B => A)(extractor: A => B)(
      implicit format: ValueFormat[B]): ValueFormat[A] =
    formatFromFunctionsWithError(constructor andThen (a => Right(a)))(extractor)

  def formatFromFunctionsEither[A, B](constructor: B => Either[String, A])(
  ...
  private def formatFromFunctionsWithError[A, B](
      constructor: B => Either[DatastoreError, A])(extractor: A => B)(
      implicit format: ValueFormat[B]): ValueFormat[A] = new ValueFormat[A] {
